...
cf_resources=$(
  jq -n \
    ...
    '
    {
      ...
      "credhub": {"instance_type": { "id": "m4.large" }, "instances": 1, "internet_connected": $internet_connected},
      "diego_brain": {"instances": 1, "internet_connected": $internet_connected},
      "diego_cell": {"instance_type": { "id": "m4.large" }, "instances": 1, "internet_connected": $internet_connected},
      ...
      "ha_proxy": {"instances": 1, "internet_connected": $internet_connected},
      ...
      "nfs_server": {"instances": 1, "internet_connected": $internet_connected},
      ...
      "tcp_router": {"instances": 1, "internet_connected": $internet_connected},
